            ...
            <div className="flex-grow flex flex-col items-center gap-8 bg-white p-4">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center w-full max-w-[1281px] gap-8">
                    <div className="w-full lg:w-[384px] h-auto">
                        <img src="/assets/images/tracking/tracking_bb.png" alt="Descriptive Alt Text" className="w-full h-auto object-cover rounded-[20px]" />
                    </div>
                        ...
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <div className="relative">
                                <div className="flex items-center gap-[12px]" onClick={toggleDropdown}>
                                    ...
                                    <img src="/assets/images/dropdown_icon.svg" alt="Dropdown icon" className="w-[26px] h-[26px] cursor-pointer" />
                                </div>
                                {dropdownOpen && (
                    ...
                    <table className="rounded-[20px] overflow-hidden min-w-full bg-white shadow-lg ">
                        <thead>
                            <tr className="bg-[#FFE3E7]">
                                ...
                                <th className="py-4 px-6 text-left">Total Pertambahan Berat Badan (Kg)</th>
                                <th className="py-4 px-6 text-left">Rerata Pertambahan BB Hamil Trimester II dan III (Kg/minggu)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
