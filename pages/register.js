      ...
      <div className="relative z-10 w-full flex-grow flex items-center justify-center p-8">
        <div className="w-full max-w-[500px] flex-shrink-0 rounded-[20px] bg-white shadow-lg">
          ...
          <h1 className="text-center text-xl font-semibold text-red-400 mt-12 pt-6">
            Masukkan informasi untuk melakukan
            <br />
            registrasi akun GERNIMAS
          </h1>
          <div className="pt-6 px-8 md:px-16">
            <form
              className="w-full flex flex-col items-center mt-3"
              onSubmit={step === 1 ? handleValidation : handleRegister}
            >
              {step === 1 ? (
                <>
                  <div className="w-full mb-6">
                    <label className="block mb-2 text-base font-medium text-red-400">
                      Nama:
                    </label>
                    <input
                      type="text"
            ...
            <p className="mt-6 p-4 text-center text-sm text-red-400">
              Dengan melakukan registrasi, saya menyetujui ketentuan penggunaan
              dan kebijakan privasi GERNIMAS
            </p>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-20">
          ...
          >
            ...
            <p className="text-center text-red-400 mt-6">
              Anda telah berhasil melakukan registrasi akun GERNIMAS. Selamat
              Datang!
            </p>
          </div>
        </div>
