...
const foodData = [
    ...
    },
    {
        ...
        trimester1: "4 Porsi",
        description: "1 Porsi = 50 gr atau 1 potong sedang tempe, 1 Porsi = 100 gr atau 2 potong sedang tahu"
    },
    {
        no: 4,
        item: "Sayur-sayuran",
    ...
    },
    {
        ...
        item: "Buah-buahan",
        trimester1: "4 Porsi",
        description: "1 Porsi = 100 gr atau 1 potong sedang pisang, 1 Porsi = 100-190 gr atau 1 potong besar pepaya"
    },
    {
        no: 6,
        item: "Minyak / Lemak",
        trimester1: "5 Porsi Minyak atau lemak termasuk santan yang digunakan dalam pengolahan, makanan digoreng, ditumis atau dimasak dengan santan",
        description: "1 Porsi = 5 gr atau 1 sendok teh, bersumber dari pengolahan makanan seperti menggoreng, menumis, santan, kemiri, mentega dan sumber lemak lainnya"
    },
    {
        no: 7,
        item: "Gula",
        trimester1: "2 Porsi",
        description: "1 Porsi = 10 gr atau 1 sendok makan bersumber dari kue-kue manis, minum teh manis dan lain-lainnya"
    }
];
    ...
    return (
        <div>
            ...
            <div className="flex items-center gap-1.5 pt-6 pl-4 md:pl-20 bg-white">
                ...
                <p className="text-custom-color text-red-400 text-base font-bold leading-normal">Asupan Gizi</p>
                <img src="/assets/images/arrow.png" className="w-[20px] h-[20px]" />
                <p className="text-custom-color text-red-400 text-base font-bold leading-normal">Trimester Pertama</p>
            </div>
