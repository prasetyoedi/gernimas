...
const HomeUser = () => {
    return (
        <div>
            ...
            {/*Services  */}
            {/* <div className="bg-white md:p-16 pt-14">
                <div class="w-full text-center text-red-400 text-xl md:text-3xl font-bold font-['Poppins'] mb-8 uppercase">
                    Services
                </div>
            </div> */}
                            ...
                            <div class="flex justify-start items-start gap-6 md:gap-20 flex-wrap">
                                <div className=" w-[198px] h-[250px] shadow-xl bg-red-100 rounded-t-[40px] rounded-b-2xl">
                                    ...
                                    <div className="card-body ">
                                        <div class="text-center text-red-400 text-xl font-bold font-['Poppins'] mt-4">
                                            AGENDA
                                        </div>
                                ...
                                <div className="card w-[198px] h-[250px] shadow-xl bg-red-100 rounded-t-[40px] rounded-b-2xl">
                                    ...
                                    />
                                    <div className="card-body ">
                                        <div class="text-center text-red-400 text-xl font-bold font-['Poppins'] mt-4 uppercase">
                                            Asupan Gizi
                                        </div>
                                        <div className="pt-7 ps-3">
                                            <svg
                                ...
                                <div className="card w-[198px] h-[250px] shadow-xl bg-red-100 rounded-t-[40px] rounded-b-2xl">
                                    ...
                                    />
                                    <div className="card-body ">
                                        <div class="text-center text-red-400 text-xl font-bold font-['Poppins'] uppercase">
                                            suplemen
                                        </div>
                                        <div className="pt-7 ps-3">
                                            <svg
