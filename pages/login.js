            ...
            <div className="relative z-10 w-full flex-grow flex items-center justify-center p-4">
                <div className="w-full max-w-[500px] flex-shrink-0 rounded-[20px] bg-white shadow-lg">
                    ...
                    <h1 className="text-center text-xl font-semibold text-red-400 mt-12 pt-6">
                        Masukkan e-mail Bunda untuk masuk<br />GERNIMAS
                    </h1>
                    <div className="pt-6 px-8 md:px-16">
                        <form className="w-full flex flex-col items-center mt-3" onSubmit={handleSubmit}>
                            <input
                                type="email"
                            ...
                            <div className="w-full mb-6 relative">
                                ...
                                >
                                    {passwordShown ? (
                                        <img src="/assets/images/login-register/eye.svg" alt="Show Password" className="w-[24px] h-[24px]" />
                                    ) : (
                                        <img src="/assets/images/login-register/eye-sleep.svg" alt="Hide Password" className="w-[24px] h-[24px]" />
                                    )}
                                </button>
                            </div>
                            <button
            ...
            {showPopup && (
                <div className="fixed inset-0 flex items-center justify-center z-20">
                    ...
                    <div className="bg-pink-100 rounded-lg shadow-lg p-16 z-30 flex flex-col items-center justify-center" style={{ width: '400px', height: '300px' }}>
                        ...
                        <h2 className="text-xl font-semibold text-red-400 mb-2">BERHASIL LOGIN!</h2>
                        <p className="text-center text-red-400 mt-6">Anda telah berhasil login ke akun Anda. Selamat Datang kembali!</p>
                    </div>
                </div>
            )}
        </div>
