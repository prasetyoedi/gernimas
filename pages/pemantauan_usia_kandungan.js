...
const PemantauanUsiaKandungan = () => {
  const fetalDevelopmentData = [
    ...
    },
    {
      ...
      length: "2,5 cm",
      organDevelopment:
        "Hidung, telinga, jari jemari mulai dibentuk. Kepala menekuk ke dada.",
    },
    {
      week: "12 Minggu",
      ...
      length: "9 cm",
      organDevelopment:
        "Daun telinga lebih jelas, kelopak mata melekat, leher mulai terbentuk, genetalia eksterna terbentuk tetapi belum berdiferensiasi.",
    },
    {
      week: "16 Minggu",
    ...
    },
    {
      ...
      length: "30 - 32 cm",
      organDevelopment:
        "Kedua kelopak mata ditumbuhi alis dan bulu mata serta kulit keriput. Kepala besar. Jika lahir, dapat bernafas tetapi hanya bertahan hidup beberapa jam saja.",
    },
    {
      week: "28 Minggu",
      ...
      length: "35 cm",
      organDevelopment:
        "Kulit berwarna merah dan ditutupi verniks kaseosa. Jika lahir dapat bernafas, menangis pelan dan lemah. Bayi imatur.",
    },
    {
      week: "32 Minggu",
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-[1281px]">
          ...
          <div className="w-full sm:w-[50%] h-[50%] flex-shrink-0 rounded-[22px] border-[2px] border-[#E5677A] bg-white m-2">
            <div className="w-full h-[80.111px] rounded-t-[20px] border border-[#E5677A] bg-[rgba(229,103,122,0.70)]">
              <p className="text-[22px] font-bold text-white text-center mt-5">
