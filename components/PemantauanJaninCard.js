...
const PemantauanJaninCard = ({ href, image, week, length }) => (
    <Link href={`${href}?week=${week}`}>
      <div className="flex flex-col items-center rounded-2xl bg-[rgba(229,103,122,0.70)] w-[380px] m-2 transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
        <div className="flex flex-col items-center gap-4 p-4 sm:p-6 w-[380px] rounded-t-2xl border border-[rgba(229,103,122,0.70)] bg-white h-auto">
          <div className="w-[135px] h-auto bg-cover bg-center bg-no-repeat">
